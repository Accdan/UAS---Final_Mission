...
<head>
    ...
    <title>OCAFE | Event - Detail</title>
                    ...
                    <?php
                        foreach ($partnerd as $pard):
                            if ($pard['pid'] == $evend['pid']):
                                ?>
                                <img src="<?= htmlspecialchars(displayImage($pard['ppict'])); ?>" alt="Partner Image">
                                <?php
                            endif;
                        endforeach;
                        ?>
